  ...
  return (
    <div className="relative">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 z-30 flex flex-col items-center px-4 pb-10 sm:px-6 sm:pb-16 md:pb-20">
        <p className="font-heading mb-0 text-center text-xl font-thin tracking-[0.03em] text-white sm:mb-10 sm:text-4xl sm:tracking-[0.04em] md:mb-12 md:text-5xl md:tracking-[0.05em] lg:text-[3.25rem] lg:tracking-[0.06em]">
