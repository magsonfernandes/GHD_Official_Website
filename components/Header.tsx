  ...
  return (
    <div className="relative w-full bg-white">
      <div className="flex h-14 w-full items-stretch md:h-16">
        <div className="relative z-10 flex min-w-0 flex-1 items-center px-3 sm:px-6 lg:px-10">
          <Link
            href="/"
          ...
          <button
            type="button"
            className="ml-auto flex h-10 w-10 shrink-0 items-center justify-center text-charcoal transition-colors hover:text-charcoal/70 md:hidden"
